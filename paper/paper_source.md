...
REF: Government of India, Ministry of Agriculture and Farmers Welfare, "Agriculture census 2015-16: All India report on number and area of operational holdings," Agriculture Census Division, New Delhi, India, 2020.
REF: Food and Agriculture Organization of the United Nations, "Smallholders and family farms," FAO, Rome, Italy, 2018.
REF: C. A. Damalas and I. G. Eleftherohorinos, "Pesticide exposure, safety issues, and risk assessment indicators," International Journal of Environmental Research and Public Health, vol. 8, no. 5, pp. 1402-1419, May 2011.
REF: Ministry of Agriculture and Farmers Welfare, "National Mission on Agricultural Extension and Technology: Sub-Mission on Agricultural Mechanization -- operational guidelines," Government of India, New Delhi, India, 2014.
REF: A. Bechar and C. Vigneault, "Agricultural robots for field operations: Concepts and components," Biosystems Engineering, vol. 149, pp. 94-111, Sep. 2016.
REF: A. Bechar and C. Vigneault, "Agricultural robots for field operations. Part 2: Operations and systems," Biosystems Engineering, vol. 153, pp. 110-128, Jan. 2017.
REF: Functional Safety of Electrical/Electronic/Programmable Electronic Safety-Related Systems, IEC 61508:2010, International Electrotechnical Commission, Geneva, Switzerland, 2010.
REF: Agricultural Machinery and Tractors -- Safety of Highly Automated Agricultural Machines, ISO 18497:2018, International Organization for Standardization, Geneva, Switzerland, 2018.
REF: D. C. Slaughter, D. K. Giles and D. Downey, "Autonomous robotic weed control systems: A review," Computers and Electronics in Agriculture, vol. 61, no. 1, pp. 63-78, Apr. 2008.
REF: R. Oberti et al., "Selective spraying of grapevines for disease control using a modular agricultural robot," Biosystems Engineering, vol. 146, pp. 203-215, Jun. 2016.
REF: T. Krajnik et al., "A practical multirobot localization system," Journal of Intelligent and Robotic Systems, vol. 76, no. 3-4, pp. 539-562, Dec. 2014.
REF: Modbus Organization, "MODBUS over serial line: Specification and implementation guide," version 1.02, Hopkinton, MA, USA, 2006.
REF: G. Jocher, A. Chaurasia and J. Qiu, "Ultralytics YOLO," software documentation, version 8.0.0, 2023. [Online]. Available: https://docs.ultralytics.com
REF: R. David et al., "TensorFlow Lite Micro: Embedded machine learning for TinyML systems," in Proceedings of Machine Learning and Systems, vol. 3, pp. 800-811, 2021.
REF: S. Thrun, W. Burgard and D. Fox, Probabilistic Robotics. Cambridge, MA, USA: MIT Press, 2005.
REF: H. Choset, "Coverage for robotics: A survey of recent results," Annals of Mathematics and Artificial Intelligence, vol. 31, no. 1-4, pp. 113-126, 2001.
REF: R. C. Coulter, "Implementation of the pure pursuit path tracking algorithm," Robotics Institute, Carnegie Mellon University, Pittsburgh, PA, USA, Tech. Rep. CMU-RI-TR-92-01, 1992.
REF: Tractors and Machinery for Agriculture and Forestry -- Serial Control and Communications Data Network -- Part 10: Task Controller and Management Information System Data Interchange, ISO 11783-10:2015, International Organization for Standardization, Geneva, Switzerland, 2015.
